...
namespace Clayxels{
	...
	*/
	...
	public class ClayObject : MonoBehaviour{
		...
		/* Is this clayObject only leaving color on other primitives? */
		...
		/* Set if this clayObject should only leave color on other primitives. */
		...
		/* Is this clayObject being mirrored on the X axis? */
		...
		/* Set if this clayObject should mirror on the X axis. */
