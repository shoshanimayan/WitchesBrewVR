	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float outBoxFlipped39 = 0;
				{
				clayxelMicrovoxelVert(inVertexId39, inVertexPos39, outVertexPos39, outChunkId39, outBoundsCenter39, outBoundsSize39, outScreenPos39, outBoxFlipped39);
				}
				...
				float vertexToFrag69 = outBoxFlipped39;
						 ...
						 ) : SV_Target
			{
				...
				float inBoxFlipped43 = vertexToFrag69;
				float3 lightDir43 = _MainLightPosition.xyz;
				{
				_sssLightDir = lightDir43.xyz;
				float3 splatPos = 0;
				float outAlpha = 0;
				clayxelMicrovoxelFrag(inViewDir43, inBoxFlipped43, inBoundsCenter43, inBoundsSize43, inVertexId43, inVertexPos43, inScreenPos43, splatPos, outColor43, outNormal43, outEmission43, outDepth43, outAlpha);
...
/*ASEBEGIN
Version=18900
284;213;1085;550;3731.236;-554.0166;1.6;True;False
Node;AmplifyShaderEditor.VertexIdVariableNode;37;-2406.573,35.91288;Inherit;False;0;1;INT;0
Node;AmplifyShaderEditor.SamplerNode;46;-2521.854,319.2272;Inherit;True;Property;_MainTex;SplatTexture;0;1;[NoScaleOffset];Fetch;False;0;0;0;False;0;False;-1;1aa3096b1b9d9204eaa6c75a4275adb1;1aa3096b1b9d9204eaa6c75a4275adb1;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CustomExpressionNode;39;-2148.297,224.8253;Inherit;False;clayxelMicrovoxelVert(inVertexId, inVertexPos, outVertexPos, outChunkId, outBoundsCenter, outBoundsSize, outScreenPos, outBoxFlipped)@;1;True;9;True;outChunkId;FLOAT;0;Out;;Inherit;False;True;inVertexId;INT;0;In;;Inherit;False;True;inVertexPos;FLOAT3;0,0,0;In;;Inherit;False;True;inSplatTexture;FLOAT4;0,0,0,0;In;;Inherit;False;True;outScreenPos;FLOAT4;0,0,0,0;Out;;Inherit;False;True;outBoundsCenter;FLOAT3;0,0,0;Out;;Inherit;False;True;outBoundsSize;FLOAT3;0,0,0;Out;;Inherit;False;True;outVertexPos;FLOAT3;0,0,0;Out;;Inherit;False;True;outBoxFlipped;FLOAT;0;Out;;Inherit;False;clayxelMicroVoxelVertexNode;False;False;0;10;0;FLOAT;0;False;1;FLOAT;0;False;2;INT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT4;0,0,0,0;False;5;FLOAT4;0,0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;9;FLOAT;0;False;7;FLOAT;0;FLOAT;2;FLOAT4;6;FLOAT3;7;FLOAT3;8;FLOAT3;9;FLOAT;10
...
Node;AmplifyShaderEditor.VertexIdVariableNode;40;-1645.751,-34.27067;Inherit;False;0;1;INT;0
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;78;-1648.811,490.6598;Inherit;False;False;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;66;-1644.384,-210.948;Inherit;False;World;True;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
ASEEND*/
//CHKSM=757EC0A0ECFEA3BBAAB00451556A651BEE9CDE2C